...
<section id="2">
    ...
    <div class="container" style="margin-left: 40%;">
        <div class="raw">
            <div class="col-md-12">
                <form action="/Card-system/Admin/Email/send" method="post" enctype="multipart/form-data" style="margin-top: 40px;">
                    <p class="short-input ue-clear">
                        ...
                        <select name="to_id" style="width: 180px; color: #46b8da;">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>+1" style="color: #46b8da;"><?php echo ($vol["truename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </p>
                    <p class="short-input ue-clear">
