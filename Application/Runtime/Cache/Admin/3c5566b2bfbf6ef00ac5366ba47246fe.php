...
<head>
    ...
    <link rel="stylesheet" href="/Card-system/Public/Admin/css/login.css" />
    <title>一卡通管理系统</title>
</head>
<body>
<div id="container">
            ...
            <div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        -->
                        <cite><img style="margin-left: 3px;" src="/Card-system/Admin/Public/captcha" onclick="this.src='/Card-system/Admin/Public/captcha/t/'+Math.random()" /></cite>
                    </p>
                </div>
...
<div id="ft">CopyRight&nbsp;2020&nbsp;&nbsp;版权所有&nbsp;&nbsp;onecard.com专注于ui设计&nbsp;&nbsp;渝ICP备09003079号</div>
</body>
