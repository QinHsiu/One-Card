...
poster varcher(20) NOT NULL,
comment text NOT NULL,
reply text NOT NULL,
mail varcher(60) NOT NULL,
ip varcher(15) NOT NULL
...
(null,'admin',MD5('123456iTca'),'iTca')

use tp_study;
insert into think_uer values
(null,'to',MD5('123456'));
...
use db_ecommercel;
create table itcast_attribute(
aid int unsigned Primary Key auto_increment,
aname varchar(20),
a_def_val varchar(255),
cid int unsigned
);
...
use db_ecommercel;
create table itcast_goods_attr(
gaid int unsigned Primary Key auto_increment,
gid int unsigned,
aid int unsigned,
avalue varchar(255)
);
